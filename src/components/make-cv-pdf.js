    ...
    content: [
      {
        ...
        table: {
          ...
          body: [
            [
              {
                text: `${cv.resume.nome} (${cv.resume.apelido})`,
...
const mkBasicInfo = () => {
  return {
    style: "body",
    text: `${cv.resume.country}, born in ${cv.resume.hometown}, ${cv.resume.birthdate}, state of ${cv.resume.state}. 
      ${cv.resume.bio}
      ${cv.contact.email} // ${cv.contact.telefone}
    `,
  };
};

const mkWorkExperience = () => {
